...
if($_POST)
{
    ...
    {
        $query = $db->ssql("UPDATE blog SET blogtitle=?, blogtext=? WHERE blogid=?");
        $update =   $query->execute([$edittitle, $edittext, $info["blogid"]]);
        ...
        <div class="row">
            <div class="col-md-8">
                <form method="POST">
                    ...
                    <textarea class="form-control t-1" name="edittext" cols="30" rows="60"><?php echo $info["blogtext"]?></textarea>
